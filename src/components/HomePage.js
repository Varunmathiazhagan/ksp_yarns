    ...
    <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center">
      ...
      >
        <h1 className="text-4xl md:text-6xl font-bold text-white mb-4">
          Welcome to <span className="text-blue-400">KSP Yarns</span>
        </h1>
        <p className="text-lg md:text-xl text-gray-200 mb-8">Premium Quality Yarns for a Sustainable Future</p>
        <motion.button
  ...
  return (
    ...
    >
      <h2 className="text-3xl md:text-4xl font-bold mb-6">
        Discover <span className="text-blue-600">KSP Yarns</span>
      </h2>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12">
        <FeatureCard
          ...
          title="Eco-Friendly"
          description="Our yarns are produced using sustainable practices to minimize environmental impact."
        />
        <FeatureCard
          icon={<FaRecycle className="text-blue-500" />}
          title="Recycled Fibers"
          description="We offer a range of yarns made from recycled materials, promoting circular economy."
        />
        <FeatureCard
  ...
  return (
    ...
    >
      <h2 className="text-2xl md:text-3xl font-bold text-center mb-8">
        Why Choose <span className="text-blue-600">KSP Yarns?</span>
      </h2>
      <ul className="list-disc list-inside space-y-4 text-gray-700 text-lg leading-relaxed">
        {[
          "Wide range of yarn types including recycled, OE, ring spun, and vortex yarns",
  ...
  return (
    ...
    >
      ...
      <p className="text-lg md:text-xl text-gray-600 text-center mb-8">
        At KSP Yarns, we are dedicated to reducing our environmental footprint through innovative practices and
